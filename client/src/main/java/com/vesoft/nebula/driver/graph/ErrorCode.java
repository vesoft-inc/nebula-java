...
public enum ErrorCode {
    ...
    RUNTIME_LABEL_TYPE_FILTER("01006"),
    ...
    INVALID_SYNTAX_DDL_MIXED_WITH_NON_DDL("42N48"),
    ...
    INVALID_SYNTAX_COMMANDS_MUST_BE_TOP_LEVEL("42N57"),
    INVALID_SYNTAX_FINISH_IN_COMPOSITE_QUERY("42N58"),
    ...
    PROPERTY_VALUE_EXCEEDS_LIMIT("ND014"),
    ...
    KVSTORE_SHUTDOWN_IN_PROGRESS("TK021"),
    CATALOG_ERROR("NC000"),
    ...
    META_NOT_SPECIFIED_ALL_ZONE_CONFIGURATION("NI121"),
    META_PART_MEMBER_CHANGE_FAILED("NI200"),
    ...
    STORAGE_CODEC_UNSUPPORTED_SYSTEM_FIELD("NO016"),
    ...
    INVALID_CONSTRUCT_SET_EXPR_INPUT("NR030"),
    INVALID_CONSTRUCT_MAP_EXPR_INPUT("NR031"),
    DDL_FAILED("NR100"),
    ...
    TEMP_GRAPH_COMPUTE_FAILED("NR153"),
    ...
    VECTOR_DIMENSION_MISMATCHED("TW501"),
    ...
    INVALID_EXPORT_STATEMENT("NS249"),
    INVALID_SIDE_EFFECT_EXPR("NS250"),
    UNSUPPORTED_STATEMENT_IN_SUBQUERY("NS251"),
    INVALID_GRAPH_VARIABLE_DEFINITION("NS252"),
    INVALID_PER_PARTITION("NS253"),
    OPTIMIZER_INTERNAL_ERROR("NZ001"),
    UNSUPPORTED("NT000"),
    ...
    UNSUPPORTED_LAZYLOAD_NODE("NT303"),
    ...
    public boolean isRpcError() {
        return code.startsWith("TN");
    }


    public boolean isRaftError() {
        return code.startsWith("TA");
    }
