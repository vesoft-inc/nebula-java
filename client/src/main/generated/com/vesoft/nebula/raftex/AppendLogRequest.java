...
public class AppendLogRequest implements TBase, java.io.Serializable, Cloneable, Comparable<AppendLogRequest> {
  ...
  private static final int __LAST_LOG_TERM_SENT_ISSET_ID = 7;
  private static final int __LAST_LOG_ID_SENT_ISSET_ID = 8;
  private static final int __LOG_TERM_ISSET_ID = 9;
  private static final int __SENDING_SNAPSHOT_ISSET_ID = 10;
  ...
  public AppendLogRequest setLeader_ip(int leader_ip) {
    this.leader_ip = leader_ip;
    setLeader_ipIsSet(true);
    return this;
  }
