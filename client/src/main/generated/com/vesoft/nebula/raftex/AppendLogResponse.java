...
public class AppendLogResponse implements TBase, java.io.Serializable, Cloneable, Comparable<AppendLogResponse> {
  ...
  private static final TField LEADER_IP_FIELD_DESC = new TField("leader_ip", TType.I32, (short)3);
  ...
  public static final int LEADER_IP = 3;
  ...
  private static final int __LEADER_IP_ISSET_ID = 2;
  ...
  public AppendLogResponse setLeader_ip(int leader_ip) {
    this.leader_ip = leader_ip;
    setLeader_ipIsSet(true);
    return this;
  }
