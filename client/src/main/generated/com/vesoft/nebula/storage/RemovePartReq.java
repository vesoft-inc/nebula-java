...
public class RemovePartReq implements TBase, java.io.Serializable, Cloneable, Comparable<RemovePartReq> {
  private static final TStruct STRUCT_DESC = new TStruct("RemovePartReq");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(RemovePartReq.class, metaDataMap);
  }
   ...
   */
  public RemovePartReq(RemovePartReq other) {
  ...
  public RemovePartReq deepCopy() {
    return new RemovePartReq(this);
  }

  @Deprecated
  public RemovePartReq clone() {
    return new RemovePartReq(this);
  }
  ...
  public RemovePartReq setSpace_id(int space_id) {
    this.space_id = space_id;
    setSpace_idIsSet(true);
    return this;
  }
  ...
  public RemovePartReq setPart_id(int part_id) {
    this.part_id = part_id;
    setPart_idIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RemovePartReq)
      return this.equals((RemovePartReq)that);
    return false;
  }

  public boolean equals(RemovePartReq that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(RemovePartReq other) {
    if (other == null) {
...
String space = prettyPrint ? " " : "";
    StringBuilder sb = new StringBuilder("RemovePartReq");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
