          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.vertex_schema = new HashMap<Integer,com.vesoft.nebula.Schema>(Math.max(0, 2*_map169.size));
              for (int _i170 = 0; 
                   (_map169.size < 0) ? iprot.peekMap() : (_i170 < _map169.size); 
                   ++_i170)
              {
                int _key171;
                com.vesoft.nebula.Schema _val172;
                _key171 = iprot.readI32();
                _val172 = new com.vesoft.nebula.Schema();
                _val172.read(iprot);
                this.vertex_schema.put(_key171, _val172);
              }
              iprot.readMapEnd();
            }
          } else { 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.vertex_data = new ArrayList<ScanVertex>(Math.max(0, _list173.size));
              for (int _i174 = 0; 
                   (_list173.size < 0) ? iprot.peekList() : (_i174 < _list173.size); 
                   ++_i174)
              {
                ScanVertex _elem175;
                _elem175 = new ScanVertex();
                _elem175.read(iprot);
                this.vertex_data.add(_elem175);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.vertex_schema != null) {
      oprot.writeFieldBegin(VERTEX_SCHEMA_FIELD_DESC);
      {
        ...
        for (Map.Entry<Integer, com.vesoft.nebula.Schema> _iter176 : this.vertex_schema.entrySet())        {
    ...
    if (this.vertex_data != null) {
      oprot.writeFieldBegin(VERTEX_DATA_FIELD_DESC);
      {
        ...
        for (ScanVertex _iter177 : this.vertex_data)        {
