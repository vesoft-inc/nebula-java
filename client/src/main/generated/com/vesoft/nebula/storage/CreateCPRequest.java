...
public class CreateCPRequest implements TBase, java.io.Serializable, Cloneable, Comparable<CreateCPRequest> {
  ...
  public CreateCPRequest setSpace_id(int space_id) {
    this.space_id = space_id;
    setSpace_idIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CreateCPRequest)
      return this.equals((CreateCPRequest)that);
    return false;
  }

  public boolean equals(CreateCPRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
