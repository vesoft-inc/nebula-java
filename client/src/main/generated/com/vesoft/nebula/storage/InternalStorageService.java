...
public class InternalStorageService {
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void chainAddEdges(ChainAddEdgesRequest req, AsyncMethodCallback resultHandler524) throws TException {
      checkReady();
      chainAddEdges_call method_call = new chainAddEdges_call(req, resultHandler524, this, ___protocolFactory, ___transport);
    ...
    public static class chainAddEdges_call extends TAsyncMethodCall {
      ...
      public chainAddEdges_call(ChainAddEdgesRequest req, AsyncMethodCallback resultHandler525, TAsyncClient client521, TProtocolFactory protocolFactory522, TNonblockingTransport transport523) throws TException {
    ...
    public void chainUpdateEdge(ChainUpdateEdgeRequest req, AsyncMethodCallback resultHandler529) throws TException {
      checkReady();
      chainUpdateEdge_call method_call = new chainUpdateEdge_call(req, resultHandler529, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class chainUpdateEdge_call extends TAsyncMethodCall {
      ...
      public chainUpdateEdge_call(ChainUpdateEdgeRequest req, AsyncMethodCallback resultHandler530, TAsyncClient client526, TProtocolFactory protocolFactory527, TNonblockingTransport transport528) throws TException {
