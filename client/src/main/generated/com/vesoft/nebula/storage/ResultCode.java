...
public class ResultCode implements TBase, java.io.Serializable, Cloneable, Comparable<ResultCode> {
  private static final TStruct STRUCT_DESC = new TStruct("ResultCode");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(ResultCode.class, metaDataMap);
  }
  ...
  public ResultCode setPart_id(int part_id) {
    this.part_id = part_id;
    setPart_idIsSet(true);
    return this;
  }
  ...
  public ResultCode setLeader(com.vesoft.nebula.HostAddr leader) {
    this.leader = leader;
    return this;
  }
