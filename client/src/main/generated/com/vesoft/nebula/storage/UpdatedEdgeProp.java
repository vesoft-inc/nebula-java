...
public class UpdatedEdgeProp implements TBase, java.io.Serializable, Cloneable, Comparable<UpdatedEdgeProp> {
  private static final TStruct STRUCT_DESC = new TStruct("UpdatedEdgeProp");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(UpdatedEdgeProp.class, metaDataMap);
  }

  public UpdatedEdgeProp() {
  }
   ...
   */
  public UpdatedEdgeProp(UpdatedEdgeProp other) {
    if (other.isSetName()) {
  ...
  public UpdatedEdgeProp deepCopy() {
    return new UpdatedEdgeProp(this);
  }

  @Deprecated
  public UpdatedEdgeProp clone() {
    return new UpdatedEdgeProp(this);
  }
  ...
  public UpdatedEdgeProp setName(byte[] name) {
    this.name = name;
    return this;
  }
  ...
  public UpdatedEdgeProp setValue(byte[] value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof UpdatedEdgeProp)
      return this.equals((UpdatedEdgeProp)that);
    return false;
  }

  public boolean equals(UpdatedEdgeProp that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(UpdatedEdgeProp other) {
    if (other == null) {
...
String space = prettyPrint ? " " : "";
    StringBuilder sb = new StringBuilder("UpdatedEdgeProp");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
