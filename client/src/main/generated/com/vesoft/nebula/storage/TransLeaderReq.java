...
public class TransLeaderReq implements TBase, java.io.Serializable, Cloneable, Comparable<TransLeaderReq> {
  private static final TStruct STRUCT_DESC = new TStruct("TransLeaderReq");
  private static final TField SPACE_ID_FIELD_DESC = new TField("space_id", TType.I32, (short)1);
  private static final TField PART_ID_FIELD_DESC = new TField("part_id", TType.I32, (short)2);
  private static final TField NEW_LEADER_FIELD_DESC = new TField("new_leader", TType.STRUCT, (short)3);

  public int space_id;
  public int part_id;
  public com.vesoft.nebula.HostAddr new_leader;
  ...
  static {
    ...
    tmpMetaDataMap.put(PART_ID, new FieldMetaData("part_id", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.I32)));
    tmpMetaDataMap.put(NEW_LEADER, new FieldMetaData("new_leader", TFieldRequirementType.DEFAULT, 
        new StructMetaData(TType.STRUCT, com.vesoft.nebula.HostAddr.class)));
    metaDataMap = Collections.unmodifiableMap(tmpMetaDataMap);
  }

  static {
    FieldMetaData.addStructMetaDataMap(TransLeaderReq.class, metaDataMap);
  }
   ...
   */
  public TransLeaderReq(TransLeaderReq other) {
    __isset_bit_vector.clear();
    __isset_bit_vector.or(other.__isset_bit_vector);
    this.space_id = TBaseHelper.deepCopy(other.space_id);
    this.part_id = TBaseHelper.deepCopy(other.part_id);
    if (other.isSetNew_leader()) {
      this.new_leader = TBaseHelper.deepCopy(other.new_leader);
    }
  }
  ...
  public TransLeaderReq setSpace_id(int space_id) {
    this.space_id = space_id;
    setSpace_idIsSet(true);
    return this;
  }
  ...
  public TransLeaderReq setPart_id(int part_id) {
    this.part_id = part_id;
    setPart_idIsSet(true);
    return this;
  }
  ...
  public TransLeaderReq setNew_leader(com.vesoft.nebula.HostAddr new_leader) {
    this.new_leader = new_leader;
    return this;
  }

  public void unsetNew_leader() {
    this.new_leader = null;
  }

  // Returns true if field new_leader is set (has been assigned a value) and false otherwise
  public boolean isSetNew_leader() {
  ...
  @Override
  public int compareTo(TransLeaderReq other) {
    if (other == null) {
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.new_leader != null) {
      oprot.writeFieldBegin(NEW_LEADER_FIELD_DESC);
