...
public class AddTaskResp implements TBase, java.io.Serializable, Cloneable, Comparable<AddTaskResp> {
  private static final TStruct STRUCT_DESC = new TStruct("AddTaskResp");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(AddTaskResp.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public AddTaskResp build() {
      AddTaskResp result = new AddTaskResp();
   ...
   */
  public AddTaskResp(AddTaskResp other) {
    if (other.isSetCode()) {
      this.code = TBaseHelper.deepCopy(other.code);
    }
  }

  public AddTaskResp deepCopy() {
    return new AddTaskResp(this);
  }
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public AddTaskResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof AddTaskResp))
      return false;
    AddTaskResp that = (AddTaskResp)_that;
  ...
  @Override
  public int compareTo(AddTaskResp other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("AddTaskResp");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
