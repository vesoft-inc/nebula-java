...
public class ScanEdgeRequest implements TBase, java.io.Serializable, Cloneable, Comparable<ScanEdgeRequest> {
  ...
  public ScanEdgeRequest setReturn_columns(Map<Integer,List<PropDef>> return_columns) {
    this.return_columns = return_columns;
    return this;
  }
  ...
  public ScanEdgeRequest setAll_columns(boolean all_columns) {
    this.all_columns = all_columns;
    setAll_columnsIsSet(true);
    return this;
  }
  ...
  public ScanEdgeRequest setLimit(int limit) {
    this.limit = limit;
    setLimitIsSet(true);
    return this;
  }
          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.return_columns = new HashMap<Integer,List<PropDef>>(Math.max(0, 2*_map142.size));
              for (int _i143 = 0; 
                   (_map142.size < 0) ? iprot.peekMap() : (_i143 < _map142.size); 
                   ++_i143)
              {
                int _key144;
                List<PropDef> _val145;
                _key144 = iprot.readI32();
                {
                  TList _list146 = iprot.readListBegin();
                  _val145 = new ArrayList<PropDef>(Math.max(0, _list146.size));
                  for (int _i147 = 0; 
                       (_list146.size < 0) ? iprot.peekList() : (_i147 < _list146.size); 
                       ++_i147)
                  {
                    PropDef _elem148;
                    _elem148 = new PropDef();
                    _elem148.read(iprot);
                    _val145.add(_elem148);
                  }
                  iprot.readListEnd();
                }
                this.return_columns.put(_key144, _val145);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.return_columns != null) {
      oprot.writeFieldBegin(RETURN_COLUMNS_FIELD_DESC);
      {
        ...
        for (Map.Entry<Integer, List<PropDef>> _iter149 : this.return_columns.entrySet())        {
          oprot.writeI32(_iter149.getKey());
          {
            oprot.writeListBegin(new TList(TType.STRUCT, _iter149.getValue().size()));
            for (PropDef _iter150 : _iter149.getValue())            {
