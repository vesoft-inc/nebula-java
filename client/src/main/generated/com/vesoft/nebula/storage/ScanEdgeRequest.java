...
public class ScanEdgeRequest implements TBase, java.io.Serializable, Cloneable, Comparable<ScanEdgeRequest> {
  ...
  public ScanEdgeRequest setUsername(byte[] username) {
    this.username = username;
    return this;
  }
  ...
  public ScanEdgeRequest setPassword(byte[] password) {
    this.password = password;
    return this;
  }
  ...
  public ScanEdgeRequest setNeed_authenticate(boolean need_authenticate) {
    this.need_authenticate = need_authenticate;
    setNeed_authenticateIsSet(true);
    return this;
  }
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.parts = new HashMap<Integer,ScanCursor>(Math.max(0, 2*_map219.size));
              for (int _i220 = 0; 
                   ...
                   ++_i220)
              {
                ...
                _val222 = new ScanCursor();
                _val222.read(iprot);
                this.parts.put(_key221, _val222);
              }
              iprot.readMapEnd();
            }
          } else { 
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.return_columns = new ArrayList<EdgeProp>(Math.max(0, _list223.size));
              for (int _i224 = 0; 
                   (_list223.size < 0) ? iprot.peekList() : (_i224 < _list223.size); 
                   ++_i224)
              {
                EdgeProp _elem225;
                _elem225 = new EdgeProp();
                _elem225.read(iprot);
                this.return_columns.add(_elem225);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.parts != null) {
      oprot.writeFieldBegin(PARTS_FIELD_DESC);
      {
        ...
        for (Map.Entry<Integer, ScanCursor> _iter226 : this.parts.entrySet())        {
    ...
    if (this.return_columns != null) {
      oprot.writeFieldBegin(RETURN_COLUMNS_FIELD_DESC);
      {
        ...
        for (EdgeProp _iter227 : this.return_columns)        {
