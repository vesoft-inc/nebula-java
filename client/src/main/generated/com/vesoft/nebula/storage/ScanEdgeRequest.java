...
public class ScanEdgeRequest implements TBase, java.io.Serializable, Cloneable, Comparable<ScanEdgeRequest> {
  ...
  public ScanEdgeRequest setVertex_id(long vertex_id) {
    this.vertex_id = vertex_id;
    setVertex_idIsSet(true);
    return this;
  }
  ...
  public ScanEdgeRequest setRow_limit(int row_limit) {
    this.row_limit = row_limit;
    setRow_limitIsSet(true);
    return this;
  }
  ...
  public ScanEdgeRequest setMax_versions(int max_versions) {
    this.max_versions = max_versions;
    setMax_versionsIsSet(true);
    return this;
  }
