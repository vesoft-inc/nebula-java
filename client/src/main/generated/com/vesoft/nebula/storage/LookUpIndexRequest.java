          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.parts = new ArrayList<Integer>(Math.max(0, _list241.size));
              for (int _i242 = 0; 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.return_columns = new ArrayList<String>(Math.max(0, _list244.size));
              for (int _i245 = 0; 
                   ...
                   ++_i245)
              {
                ...
                this.return_columns.add(_elem246);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.return_columns != null) {
      oprot.writeFieldBegin(RETURN_COLUMNS_FIELD_DESC);
      {
        ...
        for (String _iter248 : this.return_columns)        {
