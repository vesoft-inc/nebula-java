...
public class DropCPResp implements TBase, java.io.Serializable, Cloneable, Comparable<DropCPResp> {
  private static final TStruct STRUCT_DESC = new TStruct("DropCPResp");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(DropCPResp.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public DropCPResp build() {
      DropCPResp result = new DropCPResp();
   ...
   */
  public DropCPResp(DropCPResp other) {
    if (other.isSetCode()) {
      this.code = TBaseHelper.deepCopy(other.code);
    }
  }

  public DropCPResp deepCopy() {
    return new DropCPResp(this);
  }
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public DropCPResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof DropCPResp))
      return false;
    DropCPResp that = (DropCPResp)_that;
  ...
  @Override
  public int compareTo(DropCPResp other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("DropCPResp");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
