...
public class EdgeKeyRequest implements TBase, java.io.Serializable, Cloneable, Comparable<EdgeKeyRequest> {
  private static final TStruct STRUCT_DESC = new TStruct("EdgeKeyRequest");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(EdgeKeyRequest.class, metaDataMap);
  }

  public EdgeKeyRequest() {
  }
   ...
   */
  public EdgeKeyRequest(EdgeKeyRequest other) {
  ...
  public EdgeKeyRequest deepCopy() {
    return new EdgeKeyRequest(this);
  }

  @Deprecated
  public EdgeKeyRequest clone() {
    return new EdgeKeyRequest(this);
  }
  ...
  public EdgeKeyRequest setSpace_id(int space_id) {
    this.space_id = space_id;
    setSpace_idIsSet(true);
    return this;
  }
  ...
  public EdgeKeyRequest setPart_id(int part_id) {
    this.part_id = part_id;
    setPart_idIsSet(true);
    return this;
  }
  ...
  public EdgeKeyRequest setVid(long vid) {
    this.vid = vid;
    setVidIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof EdgeKeyRequest)
      return this.equals((EdgeKeyRequest)that);
    return false;
  }

  public boolean equals(EdgeKeyRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(EdgeKeyRequest other) {
    if (other == null) {
...
String space = prettyPrint ? " " : "";
    StringBuilder sb = new StringBuilder("EdgeKeyRequest");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
