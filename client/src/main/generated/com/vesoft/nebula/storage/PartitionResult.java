...
public class PartitionResult implements TBase, java.io.Serializable, Cloneable, Comparable<PartitionResult> {
   ...
   * @see ErrorCode
   */
  public PartitionResult setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PartitionResult)
      return this.equals((PartitionResult)that);
    return false;
  }

  public boolean equals(PartitionResult that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
