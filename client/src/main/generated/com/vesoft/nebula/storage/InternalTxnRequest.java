    ...
    while (true)
    {
      ...
      switch (__field.id)
      {
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.term_of_parts = new HashMap<Integer,Long>(Math.max(0, 2*_map333.size));
              for (int _i334 = 0; 
                   (_map333.size < 0) ? iprot.peekMap() : (_i334 < _map333.size); 
                   ++_i334)
              {
                int _key335;
                long _val336;
                ...
                this.term_of_parts.put(_key335, _val336);
              }
              iprot.readMapEnd();
            }
          } else { 
        ...
        case EDGE_VER:
          if (__field.type == TType.MAP) {
            {
              TMap _map337 = iprot.readMapBegin();
              this.edge_ver = new HashMap<Integer,List<Long>>(Math.max(0, 2*_map337.size));
              for (int _i338 = 0; 
                   (_map337.size < 0) ? iprot.peekMap() : (_i338 < _map337.size); 
                   ++_i338)
              {
                int _key339;
                List<Long> _val340;
                _key339 = iprot.readI32();
                {
                  ...
                  _val340 = new ArrayList<Long>(Math.max(0, _list341.size));
                  for (int _i342 = 0; 
                       (_list341.size < 0) ? iprot.peekList() : (_i342 < _list341.size); 
                       ++_i342)
                  {
                    long _elem343;
                ...
                this.edge_ver.put(_key339, _val340);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.term_of_parts != null) {
      oprot.writeFieldBegin(TERM_OF_PARTS_FIELD_DESC);
      {
        ...
        for (Map.Entry<Integer, Long> _iter344 : this.term_of_parts.entrySet())        {
          oprot.writeI32(_iter344.getKey());
    ...
    if (this.edge_ver != null) {
      if (isSetEdge_ver()) {
        oprot.writeFieldBegin(EDGE_VER_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, List<Long>> _iter345 : this.edge_ver.entrySet())          {
            oprot.writeI32(_iter345.getKey());
            {
              oprot.writeListBegin(new TList(TType.I64, _iter345.getValue().size()));
              for (long _iter346 : _iter345.getValue())              {
