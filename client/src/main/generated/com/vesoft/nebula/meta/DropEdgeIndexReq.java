...
public class DropEdgeIndexReq implements TBase, java.io.Serializable, Cloneable, Comparable<DropEdgeIndexReq> {
  ...
  public static class Builder {
    ...
    public DropEdgeIndexReq build() {
      DropEdgeIndexReq result = new DropEdgeIndexReq();
  ...
  public DropEdgeIndexReq setIndex_name(byte[] index_name) {
    this.index_name = index_name;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof DropEdgeIndexReq))
      return false;
    DropEdgeIndexReq that = (DropEdgeIndexReq)_that;
