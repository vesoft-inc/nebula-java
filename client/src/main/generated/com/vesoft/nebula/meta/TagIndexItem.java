...
public class TagIndexItem implements TBase, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("TagIndexItem");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(TagIndexItem.class, metaDataMap);
  }
   ...
   */
  public TagIndexItem(TagIndexItem other) {
  ...
  public TagIndexItem deepCopy() {
    return new TagIndexItem(this);
  }

  @Deprecated
  public TagIndexItem clone() {
    return new TagIndexItem(this);
  }
  ...
  public TagIndexItem setIndex_id(int index_id) {
    this.index_id = index_id;
    setIndex_idIsSet(true);
    return this;
  }
  ...
  public TagIndexItem setIndex_name(String index_name) {
    this.index_name = index_name;
    return this;
  }
  ...
  public TagIndexItem setFields(IndexFields fields) {
    this.fields = fields;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TagIndexItem)
      return this.equals((TagIndexItem)that);
    return false;
  }

  public boolean equals(TagIndexItem that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
...
String space = prettyPrint ? " " : "";
    StringBuilder sb = new StringBuilder("TagIndexItem");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
