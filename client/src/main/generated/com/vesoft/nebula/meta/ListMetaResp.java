...
public class ListMetaResp implements TBase, java.io.Serializable, Cloneable, Comparable<ListMetaResp> {
  private static final TStruct STRUCT_DESC = new TStruct("ListMetaResp");
  private static final TField CODE_FIELD_DESC = new TField("code", TType.I32, (short)1);
  private static final TField LEADER_FIELD_DESC = new TField("leader", TType.STRUCT, (short)2);
  private static final TField HOSTS_FIELD_DESC = new TField("hosts", TType.SET, (short)3);
  ...
  public Set<com.vesoft.nebula.HostAddr> hosts;
  ...
  static {
    FieldMetaData.addStructMetaDataMap(ListMetaResp.class, metaDataMap);
  }
  ...
  public ListMetaResp(
      ...
      Set<com.vesoft.nebula.HostAddr> hosts) {
    this();
    this.code = code;
    this.leader = leader;
    this.hosts = hosts;
  ...
  public static class Builder {
    ...
    private Set<com.vesoft.nebula.HostAddr> hosts;
    ...
    public Builder setHosts(final Set<com.vesoft.nebula.HostAddr> hosts) {
      this.hosts = hosts;
      return this;
    }

    public ListMetaResp build() {
      ListMetaResp result = new ListMetaResp();
   ...
   */
  public ListMetaResp(ListMetaResp other) {
    if (other.isSetCode()) {
  ...
  public ListMetaResp deepCopy() {
    return new ListMetaResp(this);
  }
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public ListMetaResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public ListMetaResp setLeader(com.vesoft.nebula.HostAddr leader) {
    this.leader = leader;
    return this;
  }
  ...
  public Set<com.vesoft.nebula.HostAddr> getHosts() {
    return this.hosts;
  }

  public ListMetaResp setHosts(Set<com.vesoft.nebula.HostAddr> hosts) {
    this.hosts = hosts;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case HOSTS:
      if (__value == null) {
        ...
        setHosts((Set<com.vesoft.nebula.HostAddr>)__value);
      }
      break;
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof ListMetaResp))
      return false;
    ListMetaResp that = (ListMetaResp)_that;
  ...
  @Override
  public int hashCode() {
    return Arrays.deepHashCode(new Object[] {code, leader, hosts});
  }

  @Override
  public int compareTo(ListMetaResp other) {
    if (other == null) {
      ...
      switch (__field.id)
      {
        ...
        case HOSTS:
          if (__field.type == TType.SET) {
            {
              TSet _set463 = iprot.readSetBegin();
              this.hosts = new HashSet<com.vesoft.nebula.HostAddr>(Math.max(0, 2*_set463.size));
              for (int _i464 = 0; 
                   (_set463.size < 0) ? iprot.peekSet() : (_i464 < _set463.size); 
                   ++_i464)
              {
                com.vesoft.nebula.HostAddr _elem465;
                _elem465 = new com.vesoft.nebula.HostAddr();
                _elem465.read(iprot);
                this.hosts.add(_elem465);
              }
              iprot.readSetEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.hosts != null) {
      ...
      {
        oprot.writeSetBegin(new TSet(TType.STRUCT, this.hosts.size()));
        for (com.vesoft.nebula.HostAddr _iter466 : this.hosts)        {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("ListMetaResp");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
