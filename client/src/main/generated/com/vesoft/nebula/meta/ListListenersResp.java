...
public class ListListenersResp implements TBase, java.io.Serializable, Cloneable, Comparable<ListListenersResp> {
  private static final TStruct STRUCT_DESC = new TStruct("ListListenersResp");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(ListListenersResp.class, metaDataMap);
  }

  public ListListenersResp() {
  }
  ...
  public static class Builder {
    ...
    public ListListenersResp build() {
      ListListenersResp result = new ListListenersResp();
   ...
   */
  public ListListenersResp(ListListenersResp other) {
    if (other.isSetCode()) {
  ...
  public ListListenersResp deepCopy() {
    return new ListListenersResp(this);
  }
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public ListListenersResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public ListListenersResp setLeader(com.vesoft.nebula.HostAddr leader) {
    this.leader = leader;
    return this;
  }
  ...
  public ListListenersResp setListeners(List<ListenerInfo> listeners) {
    this.listeners = listeners;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof ListListenersResp))
      return false;
    ListListenersResp that = (ListListenersResp)_that;
  ...
  @Override
  public int compareTo(ListListenersResp other) {
    if (other == null) {
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.listeners = new ArrayList<ListenerInfo>(Math.max(0, _list266.size));
              for (int _i267 = 0; 
                   (_list266.size < 0) ? iprot.peekList() : (_i267 < _list266.size); 
                   ++_i267)
              {
                ListenerInfo _elem268;
                _elem268 = new ListenerInfo();
                _elem268.read(iprot);
                this.listeners.add(_elem268);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.listeners != null) {
      oprot.writeFieldBegin(LISTENERS_FIELD_DESC);
      {
        ...
        for (ListenerInfo _iter269 : this.listeners)        {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("ListListenersResp");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
