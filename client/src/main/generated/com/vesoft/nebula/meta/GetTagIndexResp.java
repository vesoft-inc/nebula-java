...
public class GetTagIndexResp implements TBase, java.io.Serializable, Cloneable, Comparable<GetTagIndexResp> {
  ...
  public static class Builder {
    ...
    public GetTagIndexResp build() {
      GetTagIndexResp result = new GetTagIndexResp();
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public GetTagIndexResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof GetTagIndexResp))
      return false;
    GetTagIndexResp that = (GetTagIndexResp)_that;
