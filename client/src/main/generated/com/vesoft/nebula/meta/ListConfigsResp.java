...
public class ListConfigsResp implements TBase, java.io.Serializable, Cloneable, Comparable<ListConfigsResp> {
   ...
   * @see ErrorCode
   */
  public ListConfigsResp setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ListConfigsResp)
      return this.equals((ListConfigsResp)that);
    return false;
  }

  public boolean equals(ListConfigsResp that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.items = new ArrayList<ConfigItem>(Math.max(0, _list143.size));
              for (int _i144 = 0; 
                   (_list143.size < 0) ? iprot.peekList() : (_i144 < _list143.size); 
                   ++_i144)
              {
                ConfigItem _elem145;
                _elem145 = new ConfigItem();
                _elem145.read(iprot);
                this.items.add(_elem145);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.items != null) {
      oprot.writeFieldBegin(ITEMS_FIELD_DESC);
      {
        ...
        for (ConfigItem _iter146 : this.items)        {
