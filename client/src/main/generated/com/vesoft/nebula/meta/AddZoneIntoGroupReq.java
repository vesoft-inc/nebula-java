...
public class AddZoneIntoGroupReq implements TBase, java.io.Serializable, Cloneable, Comparable<AddZoneIntoGroupReq> {
  private static final TStruct STRUCT_DESC = new TStruct("AddZoneIntoGroupReq");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(AddZoneIntoGroupReq.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public AddZoneIntoGroupReq build() {
      AddZoneIntoGroupReq result = new AddZoneIntoGroupReq();
   ...
   */
  public AddZoneIntoGroupReq(AddZoneIntoGroupReq other) {
  ...
  public AddZoneIntoGroupReq deepCopy() {
    return new AddZoneIntoGroupReq(this);
  }
  ...
  public AddZoneIntoGroupReq setZone_name(byte[] zone_name) {
    this.zone_name = zone_name;
    return this;
  }
  ...
  public AddZoneIntoGroupReq setGroup_name(byte[] group_name) {
    this.group_name = group_name;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof AddZoneIntoGroupReq))
      return false;
    AddZoneIntoGroupReq that = (AddZoneIntoGroupReq)_that;
  ...
  @Override
  public int compareTo(AddZoneIntoGroupReq other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("AddZoneIntoGroupReq");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
