...
public class GetSessionResp implements TBase, java.io.Serializable, Cloneable {
   ...
   * @see ErrorCode
   */
  public GetSessionResp setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetSessionResp)
      return this.equals((GetSessionResp)that);
    return false;
  }

  public boolean equals(GetSessionResp that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
