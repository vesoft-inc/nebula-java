...
public class CheckPasswordReq implements TBase, java.io.Serializable, Cloneable, Comparable<CheckPasswordReq> {
  private static final TStruct STRUCT_DESC = new TStruct("CheckPasswordReq");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(CheckPasswordReq.class, metaDataMap);
  }
   ...
   */
  public CheckPasswordReq(CheckPasswordReq other) {
  ...
  public CheckPasswordReq deepCopy() {
    return new CheckPasswordReq(this);
  }

  @Deprecated
  public CheckPasswordReq clone() {
    return new CheckPasswordReq(this);
  }
  ...
  public CheckPasswordReq setAccount(String account) {
    this.account = account;
    return this;
  }
  ...
  public CheckPasswordReq setEncoded_pwd(String encoded_pwd) {
    this.encoded_pwd = encoded_pwd;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CheckPasswordReq)
      return this.equals((CheckPasswordReq)that);
    return false;
  }

  public boolean equals(CheckPasswordReq that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(CheckPasswordReq other) {
    if (other == null) {
...
String space = prettyPrint ? " " : "";
    StringBuilder sb = new StringBuilder("CheckPasswordReq");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
