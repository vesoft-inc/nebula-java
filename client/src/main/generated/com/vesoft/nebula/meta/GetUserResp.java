...
public class GetUserResp implements TBase, java.io.Serializable, Cloneable, Comparable<GetUserResp> {
  private static final TStruct STRUCT_DESC = new TStruct("GetUserResp");
  private static final TField CODE_FIELD_DESC = new TField("code", TType.I32, (short)1);
  private static final TField LEADER_FIELD_DESC = new TField("leader", TType.STRUCT, (short)2);
  private static final TField USER_ITEM_FIELD_DESC = new TField("user_item", TType.STRUCT, (short)3);
  ...
  static {
    FieldMetaData.addStructMetaDataMap(GetUserResp.class, metaDataMap);
  }
   ...
   */
  public GetUserResp(GetUserResp other) {
   ...
   * @see ErrorCode
   */
  public GetUserResp setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public GetUserResp setLeader(com.vesoft.nebula.HostAddr leader) {
    this.leader = leader;
    return this;
  }
  ...
  public GetUserResp setUser_item(UserItem user_item) {
    this.user_item = user_item;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetUserResp)
      return this.equals((GetUserResp)that);
    return false;
  }

  public boolean equals(GetUserResp that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(GetUserResp other) {
    if (other == null) {
...
String space = prettyPrint ? " " : "";
    StringBuilder sb = new StringBuilder("GetUserResp");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
