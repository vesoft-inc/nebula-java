...
public class ListIndexStatusResp implements TBase, java.io.Serializable, Cloneable, Comparable<ListIndexStatusResp> {
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public ListIndexStatusResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.statuses = new ArrayList<IndexStatus>(Math.max(0, _list190.size));
              for (int _i191 = 0; 
                   (_list190.size < 0) ? iprot.peekList() : (_i191 < _list190.size); 
                   ++_i191)
              {
                IndexStatus _elem192;
                _elem192 = new IndexStatus();
                _elem192.read(iprot);
                this.statuses.add(_elem192);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.statuses != null) {
      oprot.writeFieldBegin(STATUSES_FIELD_DESC);
      {
        ...
        for (IndexStatus _iter193 : this.statuses)        {
