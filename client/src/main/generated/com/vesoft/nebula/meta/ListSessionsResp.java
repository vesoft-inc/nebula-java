...
public class ListSessionsResp implements TBase, java.io.Serializable, Cloneable {
   ...
   * @see ErrorCode
   */
  public ListSessionsResp setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ListSessionsResp)
      return this.equals((ListSessionsResp)that);
    return false;
  }

  public boolean equals(ListSessionsResp that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
