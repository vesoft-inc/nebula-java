...
public class GetSyncProgressResp implements TBase, java.io.Serializable, Cloneable, Comparable<GetSyncProgressResp> {
  ...
  private static final TField PROGRESSES_FIELD_DESC = new TField("progresses", TType.MAP, (short)3);
  ...
  public GetSyncProgressResp setLeader(com.vesoft.nebula.HostAddr leader) {
    this.leader = leader;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Arrays.deepHashCode(new Object[] {code, leader, progresses});
  }
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.progresses = new HashMap<Integer,com.vesoft.nebula.SyncInfo>(Math.max(0, 2*_map458.size));
              for (int _i459 = 0; 
                   (_map458.size < 0) ? iprot.peekMap() : (_i459 < _map458.size); 
                   ++_i459)
              {
                int _key460;
                com.vesoft.nebula.SyncInfo _val461;
                _key460 = iprot.readI32();
                _val461 = new com.vesoft.nebula.SyncInfo();
                _val461.read(iprot);
                this.progresses.put(_key460, _val461);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.progresses != null) {
      oprot.writeFieldBegin(PROGRESSES_FIELD_DESC);
      {
        ...
        for (Map.Entry<Integer, com.vesoft.nebula.SyncInfo> _iter462 : this.progresses.entrySet())        {
          oprot.writeI32(_iter462.getKey());
