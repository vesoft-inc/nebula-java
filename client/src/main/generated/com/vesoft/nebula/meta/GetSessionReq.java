...
public class GetSessionReq implements TBase, java.io.Serializable, Cloneable, Comparable<GetSessionReq> {
  private static final TStruct STRUCT_DESC = new TStruct("GetSessionReq");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(GetSessionReq.class, metaDataMap);
  }
   ...
   */
  public GetSessionReq(GetSessionReq other) {
  ...
  public GetSessionReq setSession_id(long session_id) {
    this.session_id = session_id;
    setSession_idIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetSessionReq)
      return this.equals((GetSessionReq)that);
    return false;
  }

  public boolean equals(GetSessionReq that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(GetSessionReq other) {
    if (other == null) {
...
String space = prettyPrint ? " " : "";
    StringBuilder sb = new StringBuilder("GetSessionReq");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
