...
public class MultiGetResp implements TBase, java.io.Serializable, Cloneable, Comparable<MultiGetResp> {
   ...
   * @see ErrorCode
   */
  public MultiGetResp setCode(ErrorCode code) {
    this.code = code;
    return this;
  }
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.values = new ArrayList<byte[]>(Math.max(0, _list127.size));
              for (int _i128 = 0; 
