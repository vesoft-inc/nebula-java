...
public class ListAllSessionsResp implements TBase, java.io.Serializable, Cloneable {
  ...
  public ListAllSessionsResp setLeader(com.vesoft.nebula.HostAddr leader) {
    this.leader = leader;
    return this;
  }
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.sessions = new ArrayList<Session>(Math.max(0, _list308.size));
              for (int _i309 = 0; 
                   (_list308.size < 0) ? iprot.peekList() : (_i309 < _list308.size); 
                   ++_i309)
              {
                Session _elem310;
                _elem310 = new Session();
                _elem310.read(iprot);
                this.sessions.add(_elem310);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.sessions != null) {
      oprot.writeFieldBegin(SESSIONS_FIELD_DESC);
      {
        ...
        for (Session _iter311 : this.sessions)        {
