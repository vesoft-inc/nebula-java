...
public class ListTagsResp implements TBase, java.io.Serializable, Cloneable, Comparable<ListTagsResp> {
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public ListTagsResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.tags = new ArrayList<TagItem>(Math.max(0, _list86.size));
              for (int _i87 = 0; 
