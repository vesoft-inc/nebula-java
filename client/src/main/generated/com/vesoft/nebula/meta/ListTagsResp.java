...
public class ListTagsResp implements TBase, java.io.Serializable, Cloneable, Comparable<ListTagsResp> {
   ...
   * @see ErrorCode
   */
  public ListTagsResp setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ListTagsResp)
      return this.equals((ListTagsResp)that);
    return false;
  }

  public boolean equals(ListTagsResp that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.tags = new ArrayList<TagItem>(Math.max(0, _list69.size));
              for (int _i70 = 0; 
