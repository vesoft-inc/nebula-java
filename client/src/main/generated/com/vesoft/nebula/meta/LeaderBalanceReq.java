...
public class LeaderBalanceReq implements TBase, java.io.Serializable, Cloneable, Comparable<LeaderBalanceReq> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(LeaderBalanceReq.class, metaDataMap);
  }
   ...
   */
  public LeaderBalanceReq(LeaderBalanceReq other) {
  }
  ...
  @Override
  public int compareTo(LeaderBalanceReq other) {
    if (other == null) {
