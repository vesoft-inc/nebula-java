...
public class ChangeMetaResp implements TBase, java.io.Serializable, Cloneable, Comparable<ChangeMetaResp> {
  private static final TStruct STRUCT_DESC = new TStruct("ChangeMetaResp");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(ChangeMetaResp.class, metaDataMap);
  }

  public ChangeMetaResp() {
  }
  ...
  public static class Builder {
    ...
    public ChangeMetaResp build() {
      ChangeMetaResp result = new ChangeMetaResp();
   ...
   */
  public ChangeMetaResp(ChangeMetaResp other) {
    if (other.isSetCode()) {
  ...
  public ChangeMetaResp deepCopy() {
    return new ChangeMetaResp(this);
  }
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public ChangeMetaResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public ChangeMetaResp setLeader(com.vesoft.nebula.HostAddr leader) {
    this.leader = leader;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof ChangeMetaResp))
      return false;
    ChangeMetaResp that = (ChangeMetaResp)_that;
  ...
  @Override
  public int hashCode() {
    return Arrays.deepHashCode(new Object[] {code, leader});
  }

  @Override
  public int compareTo(ChangeMetaResp other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("ChangeMetaResp");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
