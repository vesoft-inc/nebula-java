...
public class GetEdgeResp implements TBase, java.io.Serializable, Cloneable, Comparable<GetEdgeResp> {
   ...
   * @see ErrorCode
   */
  public GetEdgeResp setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetEdgeResp)
      return this.equals((GetEdgeResp)that);
    return false;
  }

  public boolean equals(GetEdgeResp that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
