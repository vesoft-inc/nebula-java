...
public class ListEdgeIndexesResp implements TBase, java.io.Serializable, Cloneable, Comparable<ListEdgeIndexesResp> {
  ...
  public static class Builder {
    ...
    public ListEdgeIndexesResp build() {
      ListEdgeIndexesResp result = new ListEdgeIndexesResp();
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public ListEdgeIndexesResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof ListEdgeIndexesResp))
      return false;
    ListEdgeIndexesResp that = (ListEdgeIndexesResp)_that;
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.items = new ArrayList<IndexItem>(Math.max(0, _list195.size));
              for (int _i196 = 0; 
                   (_list195.size < 0) ? iprot.peekList() : (_i196 < _list195.size); 
                   ++_i196)
              {
                IndexItem _elem197;
                _elem197 = new IndexItem();
                _elem197.read(iprot);
                this.items.add(_elem197);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.items != null) {
      oprot.writeFieldBegin(ITEMS_FIELD_DESC);
      {
        ...
        for (IndexItem _iter198 : this.items)        {
