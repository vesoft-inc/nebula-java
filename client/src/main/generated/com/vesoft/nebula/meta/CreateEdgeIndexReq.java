...
public class CreateEdgeIndexReq implements TBase, java.io.Serializable, Cloneable, Comparable<CreateEdgeIndexReq> {
  ...
  public CreateEdgeIndexReq setIndex_params(IndexParams index_params) {
    this.index_params = index_params;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Arrays.deepHashCode(new Object[] {space_id, index_name, edge_name, fields, if_not_exists, comment, index_params});
  }
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.fields = new ArrayList<IndexFieldDef>(Math.max(0, _list187.size));
              for (int _i188 = 0; 
                   (_list187.size < 0) ? iprot.peekList() : (_i188 < _list187.size); 
                   ++_i188)
              {
                IndexFieldDef _elem189;
                _elem189 = new IndexFieldDef();
                _elem189.read(iprot);
                this.fields.add(_elem189);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.fields != null) {
      oprot.writeFieldBegin(FIELDS_FIELD_DESC);
      {
        ...
        for (IndexFieldDef _iter190 : this.fields)        {
