...
public class SignInSpaceServiceReq implements TBase, java.io.Serializable, Cloneable, Comparable<SignInSpaceServiceReq> {
  private static final TStruct STRUCT_DESC = new TStruct("SignInSpaceServiceReq");
  ...
  /**
   * 
   * @see ExternalSpaceServiceType
   */
  public ExternalSpaceServiceType type;
  ...
  static {
    FieldMetaData.addStructMetaDataMap(SignInSpaceServiceReq.class, metaDataMap);
  }

  public SignInSpaceServiceReq() {
  }

  public SignInSpaceServiceReq(
      int space_id,
      ExternalSpaceServiceType type,
  ...
  public static class Builder {
    ...
    private ExternalSpaceServiceType type;
    ...
    public Builder setType(final ExternalSpaceServiceType type) {
      this.type = type;
      return this;
    }
    ...
    public SignInSpaceServiceReq build() {
      SignInSpaceServiceReq result = new SignInSpaceServiceReq();
   ...
   */
  public SignInSpaceServiceReq(SignInSpaceServiceReq other) {
  ...
  public SignInSpaceServiceReq deepCopy() {
    return new SignInSpaceServiceReq(this);
  }
  ...
  public SignInSpaceServiceReq setSpace_id(int space_id) {
    this.space_id = space_id;
    setSpace_idIsSet(true);
    return this;
  }
   ...
   * @see ExternalSpaceServiceType
   */
  public ExternalSpaceServiceType getType() {
    return this.type;
  }
   ...
   * @see ExternalSpaceServiceType
   */
  public SignInSpaceServiceReq setType(ExternalSpaceServiceType type) {
    this.type = type;
    return this;
  }
  ...
  public SignInSpaceServiceReq setClients(List<ServiceClient> clients) {
    this.clients = clients;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case TYPE:
      if (__value == null) {
        ...
        setType((ExternalSpaceServiceType)__value);
      }
      break;
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof SignInSpaceServiceReq))
      return false;
    SignInSpaceServiceReq that = (SignInSpaceServiceReq)_that;
  ...
  @Override
  public int hashCode() {
    return Arrays.deepHashCode(new Object[] {space_id, type, clients});
  }

  @Override
  public int compareTo(SignInSpaceServiceReq other) {
    if (other == null) {
  ...
  public void read(TProtocol iprot) throws TException {
    ...
    while (true)
    {
      ...
      switch (__field.id)
      {
        ...
        case TYPE:
          if (__field.type == TType.I32) {
            this.type = ExternalSpaceServiceType.findByValue(iprot.readI32());
          } else { 
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.clients = new ArrayList<ServiceClient>(Math.max(0, _list352.size));
              for (int _i353 = 0; 
                   (_list352.size < 0) ? iprot.peekList() : (_i353 < _list352.size); 
                   ++_i353)
              {
                ServiceClient _elem354;
                _elem354 = new ServiceClient();
                _elem354.read(iprot);
                this.clients.add(_elem354);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.clients != null) {
      oprot.writeFieldBegin(CLIENTS_FIELD_DESC);
      {
        ...
        for (ServiceClient _iter355 : this.clients)        {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("SignInSpaceServiceReq");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
