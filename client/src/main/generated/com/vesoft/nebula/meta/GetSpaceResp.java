...
public class GetSpaceResp implements TBase, java.io.Serializable, Cloneable, Comparable<GetSpaceResp> {
   ...
   * @see ErrorCode
   */
  public GetSpaceResp setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetSpaceResp)
      return this.equals((GetSpaceResp)that);
    return false;
  }

  public boolean equals(GetSpaceResp that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
