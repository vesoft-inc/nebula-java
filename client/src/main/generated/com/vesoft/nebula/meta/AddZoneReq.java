...
public class AddZoneReq implements TBase, java.io.Serializable, Cloneable, Comparable<AddZoneReq> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(AddZoneReq.class, metaDataMap);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddZoneReq)
      return this.equals((AddZoneReq)that);
    return false;
  }

  public boolean equals(AddZoneReq that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(AddZoneReq other) {
    if (other == null) {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.nodes = new ArrayList<com.vesoft.nebula.HostAddr>(Math.max(0, _list188.size));
              for (int _i189 = 0; 
                   (_list188.size < 0) ? iprot.peekList() : (_i189 < _list188.size); 
                   ++_i189)
              {
                com.vesoft.nebula.HostAddr _elem190;
                _elem190 = new com.vesoft.nebula.HostAddr();
                _elem190.read(iprot);
                this.nodes.add(_elem190);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.nodes != null) {
      oprot.writeFieldBegin(NODES_FIELD_DESC);
      {
        ...
        for (com.vesoft.nebula.HostAddr _iter191 : this.nodes)        {
...
String space = prettyPrint ? " " : "";
    StringBuilder sb = new StringBuilder("AddZoneReq");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
