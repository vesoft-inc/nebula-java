...
public class AddZoneReq implements TBase, java.io.Serializable, Cloneable, Comparable<AddZoneReq> {
  ...
  public static class Builder {
    ...
    public AddZoneReq build() {
      AddZoneReq result = new AddZoneReq();
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof AddZoneReq))
      return false;
    AddZoneReq that = (AddZoneReq)_that;
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.nodes = new ArrayList<com.vesoft.nebula.HostAddr>(Math.max(0, _list208.size));
              for (int _i209 = 0; 
                   (_list208.size < 0) ? iprot.peekList() : (_i209 < _list208.size); 
                   ++_i209)
              {
                com.vesoft.nebula.HostAddr _elem210;
                _elem210 = new com.vesoft.nebula.HostAddr();
                _elem210.read(iprot);
                this.nodes.add(_elem210);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.nodes != null) {
      oprot.writeFieldBegin(NODES_FIELD_DESC);
      {
        ...
        for (com.vesoft.nebula.HostAddr _iter211 : this.nodes)        {
