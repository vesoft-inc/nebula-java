...
public class ListHostsResp implements TBase, java.io.Serializable, Cloneable, Comparable<ListHostsResp> {
  ...
  public static class Builder {
    ...
    public Builder setHosts(final List<HostItem> hosts) {
      this.hosts = hosts;
      return this;
    }

    public ListHostsResp build() {
      ListHostsResp result = new ListHostsResp();
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public ListHostsResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case HOSTS:
      if (__value == null) {
        ...
        setHosts((List<HostItem>)__value);
      }
      break;
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof ListHostsResp))
      return false;
    ListHostsResp that = (ListHostsResp)_that;
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.hosts = new ArrayList<HostItem>(Math.max(0, _list90.size));
              for (int _i91 = 0; 
                   (_list90.size < 0) ? iprot.peekList() : (_i91 < _list90.size); 
                   ++_i91)
              {
                HostItem _elem92;
                _elem92 = new HostItem();
                _elem92.read(iprot);
                this.hosts.add(_elem92);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.hosts != null) {
      oprot.writeFieldBegin(HOSTS_FIELD_DESC);
      {
        ...
        for (HostItem _iter93 : this.hosts)        {
          _iter93.write(oprot);
        }
        oprot.writeListEnd();
      }
