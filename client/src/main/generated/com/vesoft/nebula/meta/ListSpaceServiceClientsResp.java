...
public class ListSpaceServiceClientsResp implements TBase, java.io.Serializable, Cloneable, Comparable<ListSpaceServiceClientsResp> {
  ...
  public ListSpaceServiceClientsResp(
      ...
      Map<ExternalSpaceServiceType,List<ServiceClient>> clients) {
    this();
    this.code = code;
    this.leader = leader;
  ...
  public static class Builder {
    ...
    public Builder setClients(final Map<ExternalSpaceServiceType,List<ServiceClient>> clients) {
      this.clients = clients;
      return this;
    }
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public ListSpaceServiceClientsResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public ListSpaceServiceClientsResp setLeader(com.vesoft.nebula.HostAddr leader) {
    this.leader = leader;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case CLIENTS:
      if (__value == null) {
        ...
        setClients((Map<ExternalSpaceServiceType,List<ServiceClient>>)__value);
      }
      break;
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              for (int _i357 = 0; 
                   (_map356.size < 0) ? iprot.peekMap() : (_i357 < _map356.size); 
                   ++_i357)
              {
                ExternalSpaceServiceType _key358;
                List<ServiceClient> _val359;
                _key358 = ExternalSpaceServiceType.findByValue(iprot.readI32());
                {
                  TList _list360 = iprot.readListBegin();
                  _val359 = new ArrayList<ServiceClient>(Math.max(0, _list360.size));
                  for (int _i361 = 0; 
                       (_list360.size < 0) ? iprot.peekList() : (_i361 < _list360.size); 
                       ++_i361)
                  {
                    ServiceClient _elem362;
                    _elem362 = new ServiceClient();
                    _elem362.read(iprot);
    ...
    if (this.clients != null) {
      oprot.writeFieldBegin(CLIENTS_FIELD_DESC);
      {
        ...
        for (Map.Entry<ExternalSpaceServiceType, List<ServiceClient>> _iter363 : this.clients.entrySet())        {
          ...
          {
            oprot.writeListBegin(new TList(TType.STRUCT, _iter363.getValue().size()));
