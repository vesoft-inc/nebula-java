...
public class ListSpacesResp implements TBase, java.io.Serializable, Cloneable, Comparable<ListSpacesResp> {
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public ListSpacesResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.spaces = new ArrayList<IdName>(Math.max(0, _list78.size));
              for (int _i79 = 0; 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.spaces != null) {
      oprot.writeFieldBegin(SPACES_FIELD_DESC);
      {
        ...
        for (IdName _iter81 : this.spaces)        {
          _iter81.write(oprot);
        }
        oprot.writeListEnd();
      }
