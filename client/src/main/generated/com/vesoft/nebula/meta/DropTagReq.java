...
public class DropTagReq implements TBase, java.io.Serializable, Cloneable, Comparable<DropTagReq> {
  ...
  public static class Builder {
    ...
    public DropTagReq build() {
      DropTagReq result = new DropTagReq();
  ...
  public DropTagReq setTag_name(byte[] tag_name) {
    this.tag_name = tag_name;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof DropTagReq))
      return false;
    DropTagReq that = (DropTagReq)_that;
  ...
  @Override
  public int hashCode() {
    return Arrays.deepHashCode(new Object[] {space_id, tag_name, if_exists});
  }
