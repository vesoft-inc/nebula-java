...
public class GetZoneResp implements TBase, java.io.Serializable, Cloneable, Comparable<GetZoneResp> {
  private static final TStruct STRUCT_DESC = new TStruct("GetZoneResp");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(GetZoneResp.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public GetZoneResp build() {
      GetZoneResp result = new GetZoneResp();
   ...
   */
  public GetZoneResp(GetZoneResp other) {
    if (other.isSetCode()) {
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public GetZoneResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public GetZoneResp setLeader(com.vesoft.nebula.HostAddr leader) {
    this.leader = leader;
    return this;
  }
  ...
  public GetZoneResp setHosts(List<com.vesoft.nebula.HostAddr> hosts) {
    this.hosts = hosts;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof GetZoneResp))
      return false;
    GetZoneResp that = (GetZoneResp)_that;
  ...
  @Override
  public int compareTo(GetZoneResp other) {
    if (other == null) {
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.hosts = new ArrayList<com.vesoft.nebula.HostAddr>(Math.max(0, _list201.size));
              for (int _i202 = 0; 
                   (_list201.size < 0) ? iprot.peekList() : (_i202 < _list201.size); 
                   ++_i202)
              {
                com.vesoft.nebula.HostAddr _elem203;
                _elem203 = new com.vesoft.nebula.HostAddr();
                _elem203.read(iprot);
                this.hosts.add(_elem203);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.hosts != null) {
      oprot.writeFieldBegin(HOSTS_FIELD_DESC);
      {
        ...
        for (com.vesoft.nebula.HostAddr _iter204 : this.hosts)        {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("GetZoneResp");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
