...
public class GetZoneResp implements TBase, java.io.Serializable, Cloneable, Comparable<GetZoneResp> {
   ...
   * @see ErrorCode
   */
  public GetZoneResp setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetZoneResp)
      return this.equals((GetZoneResp)that);
    return false;
  }

  public boolean equals(GetZoneResp that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.hosts = new ArrayList<com.vesoft.nebula.HostAddr>(Math.max(0, _list173.size));
              for (int _i174 = 0; 
                   (_list173.size < 0) ? iprot.peekList() : (_i174 < _list173.size); 
                   ++_i174)
              {
                com.vesoft.nebula.HostAddr _elem175;
                _elem175 = new com.vesoft.nebula.HostAddr();
                _elem175.read(iprot);
                this.hosts.add(_elem175);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.hosts != null) {
      oprot.writeFieldBegin(HOSTS_FIELD_DESC);
      {
        ...
        for (com.vesoft.nebula.HostAddr _iter176 : this.hosts)        {
