...
public class GetConfigResp implements TBase, java.io.Serializable, Cloneable, Comparable<GetConfigResp> {
  private static final TStruct STRUCT_DESC = new TStruct("GetConfigResp");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(GetConfigResp.class, metaDataMap);
  }
   ...
   */
  public GetConfigResp(GetConfigResp other) {
  ...
  public GetConfigResp deepCopy() {
    return new GetConfigResp(this);
  }

  @Deprecated
  public GetConfigResp clone() {
    return new GetConfigResp(this);
  }
   ...
   * @see ErrorCode
   */
  public GetConfigResp setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public GetConfigResp setLeader(com.vesoft.nebula.HostAddr leader) {
    this.leader = leader;
    return this;
  }
  ...
  public GetConfigResp setItems(List<ConfigItem> items) {
    this.items = items;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetConfigResp)
      return this.equals((GetConfigResp)that);
    return false;
  }

  public boolean equals(GetConfigResp that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(GetConfigResp other) {
    if (other == null) {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.items = new ArrayList<ConfigItem>(Math.max(0, _list145.size));
              for (int _i146 = 0; 
                   (_list145.size < 0) ? iprot.peekList() : (_i146 < _list145.size); 
                   ++_i146)
              {
                ConfigItem _elem147;
                _elem147 = new ConfigItem();
                _elem147.read(iprot);
                this.items.add(_elem147);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.items != null) {
      oprot.writeFieldBegin(ITEMS_FIELD_DESC);
      {
        ...
        for (ConfigItem _iter148 : this.items)        {
