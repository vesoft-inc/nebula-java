...
public class GetConfigResp implements TBase, java.io.Serializable, Cloneable {
  ...
  public static class Builder {
    ...
    public GetConfigResp build() {
      GetConfigResp result = new GetConfigResp();
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public GetConfigResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof GetConfigResp))
      return false;
    GetConfigResp that = (GetConfigResp)_that;
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.items = new ArrayList<ConfigItem>(Math.max(0, _list213.size));
              for (int _i214 = 0; 
                   (_list213.size < 0) ? iprot.peekList() : (_i214 < _list213.size); 
                   ++_i214)
              {
                ConfigItem _elem215;
                _elem215 = new ConfigItem();
                _elem215.read(iprot);
                this.items.add(_elem215);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.items != null) {
      oprot.writeFieldBegin(ITEMS_FIELD_DESC);
      {
        ...
        for (ConfigItem _iter216 : this.items)        {
