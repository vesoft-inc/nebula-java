...
public class SaveGraphVersionResp implements TBase, java.io.Serializable, Cloneable, Comparable<SaveGraphVersionResp> {
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public SaveGraphVersionResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public SaveGraphVersionResp setLeader(com.vesoft.nebula.HostAddr leader) {
    this.leader = leader;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Arrays.deepHashCode(new Object[] {code, leader, error_msg});
  }
