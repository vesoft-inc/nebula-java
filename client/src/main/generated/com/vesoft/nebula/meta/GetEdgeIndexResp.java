...
public class GetEdgeIndexResp implements TBase, java.io.Serializable, Cloneable {
   ...
   * @see ErrorCode
   */
  public GetEdgeIndexResp setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public EdgeIndexItem  getItem() {
    return this.item;
  }

  public GetEdgeIndexResp setItem(EdgeIndexItem item) {
    this.item = item;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetEdgeIndexResp)
      return this.equals((GetEdgeIndexResp)that);
    return false;
  }

  public boolean equals(GetEdgeIndexResp that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
