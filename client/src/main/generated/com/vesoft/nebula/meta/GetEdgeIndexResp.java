...
public class GetEdgeIndexResp implements TBase, java.io.Serializable, Cloneable, Comparable<GetEdgeIndexResp> {
  private static final TStruct STRUCT_DESC = new TStruct("GetEdgeIndexResp");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(GetEdgeIndexResp.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public Builder setItem(final IndexItem item) {
      this.item = item;
      return this;
    }

    public GetEdgeIndexResp build() {
      GetEdgeIndexResp result = new GetEdgeIndexResp();
   ...
   */
  public GetEdgeIndexResp(GetEdgeIndexResp other) {
    if (other.isSetCode()) {
  ...
  public GetEdgeIndexResp deepCopy() {
    return new GetEdgeIndexResp(this);
  }
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public GetEdgeIndexResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public GetEdgeIndexResp setLeader(com.vesoft.nebula.HostAddr leader) {
    this.leader = leader;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof GetEdgeIndexResp))
      return false;
    GetEdgeIndexResp that = (GetEdgeIndexResp)_that;
  ...
  @Override
  public int compareTo(GetEdgeIndexResp other) {
    if (other == null) {
