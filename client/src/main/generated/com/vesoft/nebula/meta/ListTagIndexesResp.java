...
public class ListTagIndexesResp implements TBase, java.io.Serializable, Cloneable, Comparable<ListTagIndexesResp> {
   ...
   * @see ErrorCode
   */
  public ListTagIndexesResp setCode(ErrorCode code) {
    this.code = code;
    return this;
  }
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.items = new ArrayList<IndexItem>(Math.max(0, _list148.size));
              for (int _i149 = 0; 
                   (_list148.size < 0) ? iprot.peekList() : (_i149 < _list148.size); 
                   ++_i149)
              {
                IndexItem _elem150;
                _elem150 = new IndexItem();
                _elem150.read(iprot);
                this.items.add(_elem150);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.items != null) {
      oprot.writeFieldBegin(ITEMS_FIELD_DESC);
      {
        ...
        for (IndexItem _iter151 : this.items)        {
