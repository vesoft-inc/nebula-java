...
public class ScanReq implements TBase, java.io.Serializable, Cloneable, Comparable<ScanReq> {
  private static final TStruct STRUCT_DESC = new TStruct("ScanReq");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(ScanReq.class, metaDataMap);
  }
  ...
  public ScanReq setSegment(String segment) {
    this.segment = segment;
    return this;
  }
  ...
  public ScanReq setStart(String start) {
    this.start = start;
    return this;
  }
  ...
  public ScanReq setEnd(String end) {
    this.end = end;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ScanReq)
      return this.equals((ScanReq)that);
    return false;
  }

  public boolean equals(ScanReq that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
