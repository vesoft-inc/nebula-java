...
public class AddGroupReq implements TBase, java.io.Serializable, Cloneable, Comparable<AddGroupReq> {
  private static final TStruct STRUCT_DESC = new TStruct("AddGroupReq");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(AddGroupReq.class, metaDataMap);
  }
   ...
   */
  public AddGroupReq(AddGroupReq other) {
  ...
  public AddGroupReq setGroup_name(byte[] group_name) {
    this.group_name = group_name;
    return this;
  }
  ...
  public AddGroupReq setZone_names(List<byte[]> zone_names) {
    this.zone_names = zone_names;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddGroupReq)
      return this.equals((AddGroupReq)that);
    return false;
  }

  public boolean equals(AddGroupReq that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(AddGroupReq other) {
    if (other == null) {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.zone_names = new ArrayList<byte[]>(Math.max(0, _list195.size));
              for (int _i196 = 0; 
                   (_list195.size < 0) ? iprot.peekList() : (_i196 < _list195.size); 
                   ++_i196)
              {
                byte[] _elem197;
                _elem197 = iprot.readBinary();
                this.zone_names.add(_elem197);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.zone_names != null) {
      oprot.writeFieldBegin(ZONE_NAMES_FIELD_DESC);
      {
        ...
        for (byte[] _iter198 : this.zone_names)        {
...
String space = prettyPrint ? " " : "";
    StringBuilder sb = new StringBuilder("AddGroupReq");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
