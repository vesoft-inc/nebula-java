...
public class AddGroupReq implements TBase, java.io.Serializable, Cloneable, Comparable<AddGroupReq> {
  ...
  public static class Builder {
    ...
    public AddGroupReq build() {
      AddGroupReq result = new AddGroupReq();
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof AddGroupReq))
      return false;
    AddGroupReq that = (AddGroupReq)_that;
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.zone_names = new ArrayList<byte[]>(Math.max(0, _list213.size));
              for (int _i214 = 0; 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.zone_names != null) {
      oprot.writeFieldBegin(ZONE_NAMES_FIELD_DESC);
      {
        ...
        for (byte[] _iter216 : this.zone_names)        {
