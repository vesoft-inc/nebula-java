...
public class ListRolesResp implements TBase, java.io.Serializable, Cloneable, Comparable<ListRolesResp> {
  private static final TStruct STRUCT_DESC = new TStruct("ListRolesResp");
  private static final TField CODE_FIELD_DESC = new TField("code", TType.I32, (short)1);
  private static final TField LEADER_FIELD_DESC = new TField("leader", TType.STRUCT, (short)2);
  private static final TField ROLES_FIELD_DESC = new TField("roles", TType.LIST, (short)3);
  ...
  static {
    FieldMetaData.addStructMetaDataMap(ListRolesResp.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public Builder setRoles(final List<RoleItem> roles) {
      this.roles = roles;
      return this;
    }

    public ListRolesResp build() {
      ListRolesResp result = new ListRolesResp();
   ...
   */
  public ListRolesResp(ListRolesResp other) {
    if (other.isSetCode()) {
    ...
    if (other.isSetRoles()) {
      this.roles = TBaseHelper.deepCopy(other.roles);
    }
  }

  public ListRolesResp deepCopy() {
    return new ListRolesResp(this);
  }
  ...
  public ListRolesResp setLeader(com.vesoft.nebula.HostAddr leader) {
    this.leader = leader;
    return this;
  }
  ...
  public void setRolesIsSet(boolean __value) {
    if (!__value) {
      this.roles = null;
    }
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case ROLES:
      if (__value == null) {
        ...
        setRoles((List<RoleItem>)__value);
      }
      break;
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof ListRolesResp))
      return false;
    ListRolesResp that = (ListRolesResp)_that;
    ...
    if (!TBaseHelper.equalsNobinary(this.isSetRoles(), that.isSetRoles(), this.roles, that.roles)) { return false; }
  ...
  @Override
  public int hashCode() {
    return Arrays.deepHashCode(new Object[] {code, leader, roles});
  }

  @Override
  public int compareTo(ListRolesResp other) {
    if (other == null) {
    ...
    lastComparison = TBaseHelper.compareTo(roles, other.roles);
    if (lastComparison != 0) { 
      return lastComparison;
    }
    return 0;
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.roles = new ArrayList<RoleItem>(Math.max(0, _list170.size));
              for (int _i171 = 0; 
                   (_list170.size < 0) ? iprot.peekList() : (_i171 < _list170.size); 
                   ++_i171)
              {
                RoleItem _elem172;
                _elem172 = new RoleItem();
                _elem172.read(iprot);
                this.roles.add(_elem172);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.roles != null) {
      oprot.writeFieldBegin(ROLES_FIELD_DESC);
      {
        ...
        for (RoleItem _iter173 : this.roles)        {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    if (this.getRoles() == null) {
      ...
      sb.append(TBaseHelper.toString(this.getRoles(), indent + 1, prettyPrint));
    }
    first = false;
