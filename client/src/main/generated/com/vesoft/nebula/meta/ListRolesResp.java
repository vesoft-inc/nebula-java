...
public class ListRolesResp implements TBase, java.io.Serializable, Cloneable, Comparable<ListRolesResp> {
   ...
   * @see ErrorCode
   */
  public ListRolesResp setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ListRolesResp)
      return this.equals((ListRolesResp)that);
    return false;
  }

  public boolean equals(ListRolesResp that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    if (this_present_roles || that_present_roles) {
      if (!(this_present_roles && that_present_roles))
        return false;
      if (!TBaseHelper.equalsNobinary(this.roles, that.roles))
        return false;
    }
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.roles = new ArrayList<RoleItem>(Math.max(0, _list147.size));
              for (int _i148 = 0; 
                   (_list147.size < 0) ? iprot.peekList() : (_i148 < _list147.size); 
                   ++_i148)
              {
                RoleItem _elem149;
                _elem149 = new RoleItem();
                _elem149.read(iprot);
                this.roles.add(_elem149);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.roles != null) {
      oprot.writeFieldBegin(ROLES_FIELD_DESC);
      {
        ...
        for (RoleItem _iter150 : this.roles)        {
