...
public class GetTagResp implements TBase, java.io.Serializable, Cloneable, Comparable<GetTagResp> {
  private static final TStruct STRUCT_DESC = new TStruct("GetTagResp");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(GetTagResp.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public GetTagResp build() {
      GetTagResp result = new GetTagResp();
   ...
   */
  public GetTagResp(GetTagResp other) {
    if (other.isSetCode()) {
   ...
   * @see com.vesoft.nebula.ErrorCode
   */
  public GetTagResp setCode(com.vesoft.nebula.ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public GetTagResp setLeader(com.vesoft.nebula.HostAddr leader) {
    this.leader = leader;
    return this;
  }
  ...
  public GetTagResp setSchema(Schema schema) {
    this.schema = schema;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof GetTagResp))
      return false;
    GetTagResp that = (GetTagResp)_that;
  ...
  @Override
  public int hashCode() {
    return Arrays.deepHashCode(new Object[] {code, leader, schema});
  }

  @Override
  public int compareTo(GetTagResp other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("GetTagResp");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
