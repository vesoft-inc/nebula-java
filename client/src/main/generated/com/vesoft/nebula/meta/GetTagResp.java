...
public class GetTagResp implements TBase, java.io.Serializable, Cloneable, Comparable<GetTagResp> {
   ...
   * @see ErrorCode
   */
  public GetTagResp setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetTagResp)
      return this.equals((GetTagResp)that);
    return false;
  }

  public boolean equals(GetTagResp that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
