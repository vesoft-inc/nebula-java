...
public class ListUsersResp implements TBase, java.io.Serializable, Cloneable, Comparable<ListUsersResp> {
   ...
   * @see ErrorCode
   */
  public ListUsersResp setCode(ErrorCode code) {
    this.code = code;
    return this;
  }
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.users = new HashMap<byte[],byte[]>(Math.max(0, 2*_map160.size));
              for (int _i161 = 0; 
                   ...
                   ++_i161)
              {
                ...
                _val163 = iprot.readBinary();
                this.users.put(_key162, _val163);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.users != null) {
      oprot.writeFieldBegin(USERS_FIELD_DESC);
      {
        ...
        for (Map.Entry<byte[], byte[]> _iter164 : this.users.entrySet())        {
