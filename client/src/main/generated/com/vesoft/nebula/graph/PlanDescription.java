          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.plan_node_descs = new ArrayList<PlanNodeDescription>(Math.max(0, _list18.size));
              for (int _i19 = 0; 
          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.node_index_map = new HashMap<Long,Long>(Math.max(0, 2*_map21.size));
              for (int _i22 = 0; 
                   ...
                   ++_i22)
              {
                ...
                this.node_index_map.put(_key23, _val24);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.plan_node_descs != null) {
      oprot.writeFieldBegin(PLAN_NODE_DESCS_FIELD_DESC);
      {
        ...
        for (PlanNodeDescription _iter25 : this.plan_node_descs)        {
          _iter25.write(oprot);
        }
        oprot.writeListEnd();
      }
    ...
    if (this.node_index_map != null) {
      oprot.writeFieldBegin(NODE_INDEX_MAP_FIELD_DESC);
      {
        ...
        for (Map.Entry<Long, Long> _iter26 : this.node_index_map.entrySet())        {
