...
public class PlanNodeDescription implements TBase, java.io.Serializable, Cloneable, Comparable<PlanNodeDescription> {
  ...
  private static final TField DESCRIPTION_FIELD_DESC = new TField("description", TType.MAP, (short)4);
  ...
  public Map<byte[],byte[]> description;
  ...
  public Map<byte[],byte[]>  getDescription() {
    return this.description;
  }

  public PlanNodeDescription setDescription(Map<byte[],byte[]> description) {
    this.description = description;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object value) {
    ...
    case DESCRIPTION:
      if (value == null) {
        ...
        setDescription((Map<byte[],byte[]>)value);
      }
      break;
  ...
  public boolean equals(PlanNodeDescription that) {
    ...
    if (this_present_description || that_present_description) {
      if (!(this_present_description && that_present_description))
        return false;
      if (!TBaseHelper.equalsSlow(this.description, that.description))
        return false;
    }
          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.description = new HashMap<byte[],byte[]>(Math.max(0, 2*_map5.size));
              for (int _i6 = 0; 
                   (_map5.size < 0) ? iprot.peekMap() : (_i6 < _map5.size); 
                   ++_i6)
              {
                byte[] _key7;
                byte[] _val8;
                ...
                this.description.put(_key7, _val8);
              }
              iprot.readMapEnd();
            }
          } else { 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.profiles = new ArrayList<ProfilingStats>(Math.max(0, _list9.size));
              for (int _i10 = 0; 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.dependencies = new ArrayList<Long>(Math.max(0, _list12.size));
              for (int _i13 = 0; 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.description != null) {
      if (isSetDescription()) {
        ...
        {
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, this.description.size()));
          for (Map.Entry<byte[], byte[]> _iter15 : this.description.entrySet())          {
    ...
    if (this.profiles != null) {
      if (isSetProfiles()) {
        oprot.writeFieldBegin(PROFILES_FIELD_DESC);
        {
          ...
          for (ProfilingStats _iter16 : this.profiles)          {
            _iter16.write(oprot);
          }
          oprot.writeListEnd();
        }
    ...
    if (this.dependencies != null) {
      if (isSetDependencies()) {
        oprot.writeFieldBegin(DEPENDENCIES_FIELD_DESC);
        {
          ...
          for (long _iter17 : this.dependencies)          {
