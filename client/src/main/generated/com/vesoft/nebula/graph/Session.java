          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.configs = new HashMap<byte[],com.vesoft.nebula.Value>(Math.max(0, 2*_map26.size));
              for (int _i27 = 0; 
                   (_map26.size < 0) ? iprot.peekMap() : (_i27 < _map26.size); 
                   ++_i27)
              {
                byte[] _key28;
                com.vesoft.nebula.Value _val29;
                _key28 = iprot.readBinary();
                _val29 = new com.vesoft.nebula.Value();
                _val29.read(iprot);
                this.configs.put(_key28, _val29);
              }
              iprot.readMapEnd();
            }
          } else { 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.queries = new HashMap<Long,QueryDesc>(Math.max(0, 2*_map30.size));
              for (int _i31 = 0; 
                   ...
                   ++_i31)
              {
                ...
                _val33 = new QueryDesc();
                _val33.read(iprot);
                this.queries.put(_key32, _val33);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.configs != null) {
      oprot.writeFieldBegin(CONFIGS_FIELD_DESC);
      {
        ...
        for (Map.Entry<byte[], com.vesoft.nebula.Value> _iter34 : this.configs.entrySet())        {
    ...
    if (this.queries != null) {
      oprot.writeFieldBegin(QUERIES_FIELD_DESC);
      {
        ...
        for (Map.Entry<Long, QueryDesc> _iter35 : this.queries.entrySet())        {
